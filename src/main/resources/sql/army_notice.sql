...
CREATE TABLE NOTICE_BOARD
   ...
   insert into NOTICE_BOARD VALUES('admin','[공지] 백석지점 조조 영화관람 시간대 조정 안내','<table border="0" cellpadding="0" cellspacing="0" style="width: 611px;" width="611">
			...
			<p align="left"></p>
			<p align="left">감사합니다.</p>',sysdate,null,0,NOTICE_BOARD_SEQ.NEXTVAL,null);
...
<p align="left"></p>
',sysdate,null,0,NOTICE_BOARD_SEQ.NEXTVAL,null);
...
<p>감사합니다.</p>
',sysdate,null,0,NOTICE_BOARD_SEQ.NEXTVAL,null);
   insert into NOTICE_BOARD VALUES('admin','[공지] 매거진M 발행 중단으로 인한 보상 안내','
<p>안녕하세요. 메가박스입니다.</p>
